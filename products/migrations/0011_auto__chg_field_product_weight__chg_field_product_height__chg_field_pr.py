...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'products_product', 'weight', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Product.height'
        db.alter_column(u'products_product', 'height', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Product.width'
        db.alter_column(u'products_product', 'width', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Product.length'
        db.alter_column(u'products_product', 'length', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Product.weight'
        db.alter_column(u'products_product', 'weight', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Product.height'
        db.alter_column(u'products_product', 'height', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Product.width'
        db.alter_column(u'products_product', 'width', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Product.length'
        db.alter_column(u'products_product', 'length', self.gf('django.db.models.fields.IntegerField')(null=True))
